    ...
    return (
        <div className="animate-in flex-1 flex flex-col gap-8 w-full">
            <div>
                ...
                <p className="text-slate-600 mt-1">Popule e limpe o banco de dados temporariamente para validar o design.</p>
            </div>

            <div className="bg-white border border-slate-200 p-8 rounded-xl shadow-sm max-w-2xl">
