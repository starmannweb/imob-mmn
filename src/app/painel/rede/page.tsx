            ...
            <div className="w-full">
                ...
                {currentTab === 'parcerias' && (
                    <div className="w-full space-y-4">
                        ...
                        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl flex flex-col items-center justify-center py-20 px-4 text-center mt-4">
                            <div className="mb-4 bg-slate-50 dark:bg-slate-900/50 p-4 rounded-full border border-slate-100 dark:border-slate-800">
                                <Handshake className="w-12 h-12 text-slate-400 dark:text-slate-500" />
                            </div>
                            <h3 className="text-lg font-extrabold text-slate-800 dark:text-white mb-1">Nenhuma parceria ativa</h3>
                            <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Você não tem parcerias ativas no momento.</p>
                        </div>
                    </div>
                )}
